...
What every figure means, and what the screen refuses to guess. This used to sit
in the [README](../README.md); it is here so that page can be read in a minute.
...
## Regenerating the screen above

It is real renderer output, not a mock-up:
